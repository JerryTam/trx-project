...
const docTemplatebackend = `{
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/trx-project_internal_model.Permission"
                                            }
                                        }
                                    }
                                }
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/trx-project_internal_model.Role"
                                            }
                                        }
                                    }
                                }
    ...
    "definitions": {
        "trx-project_internal_model.Permission": {
            "type": "object",
            "properties": {
                "action": {
                    "description": "操作：read, write, delete",
                    "type": "string"
                },
                "code": {
                    "description": "权限编码：user:read, user:write",
                    "type": "string"
                },
                "created_at": {
                    "type": "string"
                ...
                "name": {
                    "description": "权限名称：查看用户、编辑用户",
                    "type": "string"
                },
                "resource": {
                    "description": "资源：user, role, permission, statistics",
                    "type": "string"
                },
                "status": {
        ...
        "trx-project_internal_model.Role": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
                ...
                "display_name": {
                    "description": "显示名称：超级管理员、管理员、编辑、查看者",
                    "type": "string"
                },
                "id": {
                    "type": "integer"
                ...
                "name": {
                    "description": "角色名称：superadmin, admin, editor, viewer",
                    "type": "string"
                },
                "permissions": {
                    "description": "关联",
...
func init() {
	swag.Register(SwaggerInfobackend.InstanceName(), SwaggerInfobackend)
}
